...
class _ApiService implements ApiService {
  ...
  @override
  Future<ApiResponse<List<TrainingModel>>> getTrainings() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<List<TrainingModel>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/trainings',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<List<TrainingModel>> _value;
    try {
      _value = ApiResponse<List<TrainingModel>>.fromJson(
        _result.data!,
        (json) => json is List<dynamic>
            ? json
                  .map<TrainingModel>(
                    (i) => TrainingModel.fromJson(i as Map<String, dynamic>),
                  )
                  .toList()
            : List.empty(),
      );
  ...
  @override
  Future<ApiResponse<TrainingModel>> getTrainingDetail(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<TrainingModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/trainings/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<TrainingModel> _value;
    try {
      _value = ApiResponse<TrainingModel>.fromJson(
        _result.data!,
  ...
  @override
  Future<ApiResponse<List<BatchModel>>> getBatches() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ApiResponse<List<BatchModel>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/batches',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<List<BatchModel>> _value;
    try {
      _value = ApiResponse<List<BatchModel>>.fromJson(
        _result.data!,
        (json) => json is List<dynamic>
            ? json
                  .map<BatchModel>(
                    (i) => BatchModel.fromJson(i as Map<String, dynamic>),
                  )
                  .toList()
            : List.empty(),
      );
